...
def parse_args():
    ...
    parser.add_argument('--downsize', type=int, default=4, help='显存不够，因而下采样')
    parser.add_argument('--input_h', type=int, default=128, help='input height')
    parser.add_argument('--input_w', type=int, default=128, help='input width')
    parser.add_argument('--input_s', type=int, default=100, help='input slice')
    ...
    parser.add_argument('--phase', type=str, default='my_eval', help='data directory')
