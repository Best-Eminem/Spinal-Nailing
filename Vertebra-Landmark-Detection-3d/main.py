...
def parse_args():
    ...
    parser.add_argument('--downsize', type=int, default=2, help='显存不够，因而下采样')
    ...
    parser.add_argument('--K', type=int, default=5, help='特征点的最大个数')
    ...
    parser.add_argument('--resume', type=str, default='spine_localisation.pth', help='weights to be resumed')
    parser.add_argument('--data_dir', type=str, default='E:\\ZN-CT-nii', help='data directory')
    parser.add_argument('--phase', type=str, default='spine_localisation_eval', help='data directory')
...
if __name__ == '__main__':
    ...
    if args.phase == 'spine_localisation_gt':
        save_groundtruth(nii_nums=27, landmarks_num=5, full=True,mode="spine_localisation",
                         input_slice=240,input_h=512,input_w=512,
                         down_ratio=args.down_ratio,downsize=args.downsize)
    elif args.phase == 'landmark_detection_gt':
        save_groundtruth(nii_nums=27, landmarks_num=30, full=True,mode="landmark_detection",
